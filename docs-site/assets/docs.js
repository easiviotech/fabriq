...
(function () {
    ...
    const NAV = [
        ...
        },
        {
            ...
            items: [
                ...
                { title: 'Live Streaming', href: 'streaming.html' },
                { title: 'Game Server', href: 'gaming.html' },
    ...
    const SEARCH_INDEX = [
        ...
        { title: 'Database', section: 'Data Layer', href: 'database.html' },
        { title: 'Connection Pools', section: 'Database', href: 'database.html#connection-pools' },
        { title: 'DbManager', section: 'Database', href: 'database.html#dbmanager' },
        { title: 'Transactions', section: 'Database', href: 'database.html#transactions' },
        { title: 'TenantAwareRepository', section: 'Database', href: 'database.html#repository' },
        ...
        { title: 'Live Streaming', section: 'Advanced', href: 'streaming.html' },
        ...
        { title: 'Game Server', section: 'Advanced', href: 'gaming.html' },
